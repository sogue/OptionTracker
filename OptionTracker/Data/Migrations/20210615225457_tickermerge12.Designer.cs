...
namespace OptionTracker.Migrations
{
    ...
    [Migration("20210615225457_tickermerge12")]
    partial class tickermerge12
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Legacy.HistoricalChain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Entities.Legacy.HistoricalDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Core.Entities.Legacy.HistoricalOptionContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("HistoricalOptionContract");
                });

            modelBuilder.Entity("Core.Entities.Legacy.OptionContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("HistoricalOptionContractId");

                    b.ToTable("OptionContract");
                });
            ...
            modelBuilder.Entity("Core.Entities.Legacy.Trader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TickerTrader1", b =>
                {
                    b.Property<int>("TickersId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TickerTrader1");
                });

            modelBuilder.Entity("Core.Entities.Legacy.HistoricalChain", b =>
                {
                    b.HasOne("Core.Entities.Legacy.Ticker", null)
                        .WithOne("Chain")
                        .HasForeignKey("Core.Entities.Legacy.HistoricalChain", "TickerId")
            ...
            modelBuilder.Entity("Core.Entities.Legacy.HistoricalDate", b =>
                {
                    b.HasOne("Core.Entities.Legacy.HistoricalChain", null)
                        .WithMany("Dates")
            ...
            modelBuilder.Entity("Core.Entities.Legacy.HistoricalOptionContract", b =>
                {
                    b.HasOne("Core.Entities.Legacy.HistoricalDate", null)
            ...
            modelBuilder.Entity("Core.Entities.Legacy.OptionContract", b =>
                {
                    b.HasOne("Core.Entities.Legacy.HistoricalOptionContract", null)
                        .WithMany("Contracts")
                        .HasForeignKey("HistoricalOptionContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TickerTrader1", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Legacy.Trader", null)
                        .WithMany()
                        .HasForeignKey("TradersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
